        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-lg max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">
              Please login to continue to the platform.
            </p>
            <button
        ...
        <div className="w-full md:w-1/2 bg-gradient-to-br from-white to-purple-50 p-8">
          <div className="w-full">
            <div className="flex mb-6">
              <button
                className="w-1/2 py-2 text-center bg-white text-gray-700 border border-gray-200 rounded-l-md"
                onClick={() => navigate("/signin")}
              >
                Login
              </button>
              <button className="w-1/2 py-2 text-center bg-blue-600 text-white rounded-r-md">
                Sign Up
              </button>
            </div>
